...
/// prod url
// const String prodUrl = 'http://88a7c44.r24.cpolar.top';
const String prodUrl = 'https://api.walletapp.shop';
...
class SbtAuthProvider {
  ...
  final Map<String, String> _networkMap = {
    ...
    '0x2b5c': 'bool',
    '0x1e1': 'bool_beta_testnet',
    '0x1e3': 'ultraliquid_testnet',
    '0x14a33': 'base_goerli',
    '0x2105': 'base',
